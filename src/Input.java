...
public class Input implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    private static boolean mousePressed = false;  // Se il mouse è premuto
    private static Point mousePosition = new Point(0, 0);  // Posizione del mouse
    private static int mouseWheelRotation = 0;  // Per il movimento della rotellina
    private GamePanel gamePanel;

    // Costruttore che riceve il GamePanel per registrare il KeyListener e il MouseListener
